...
var VARS = Object.defineProperties({}, {
    "_name": { get: function() { return _name; }, set: function(val) { _name = val; } },
    "_plates_amount": { get: function() { return _plates_amount; }, set: function(val) { _plates_amount = val; } },
    "x_position": { get: function() { return x_position; }, set: function(val) { x_position = val; } },
    "_plates_basic_arr": { get: function() { return _plates_basic_arr; }, set: function(val) { _plates_basic_arr = val; } },
    "_place_type": { get: function() { return _place_type; }, set: function(val) { _place_type = val; } },
    "_G_step_hor": { get: function() { return _G_step_hor; }, set: function(val) { _G_step_hor = val; } },
    "mailbox_obj": { get: function() { return mailbox_obj; }, set: function(val) { mailbox_obj = val; } },
    "_top_lable_x_pos": { get: function() { return _top_lable_x_pos; }, set: function(val) { _top_lable_x_pos = val; } },
    "_cam_update_requests": { get: function() { return _cam_update_requests; }, set: function(val) { _cam_update_requests = val; } },
    "columns": { get: function() { return columns; }, set: function(val) { columns = val; } },
    "row": { get: function() { return row; }, set: function(val) { row = val; } },
    "col": { get: function() { return col; }, set: function(val) { col = val; } },
    "parent": { get: function() { return parent2; }, set: function(val) { parent2 = val; } },
    "template": { get: function() { return template; }, set: function(val) { template = val; } },
    "where": { get: function() { return where; }, set: function(val) { where = val; } },
    "num": { get: function() { return num; }, set: function(val) { num = val; } },
    "promise": { get: function() { return promise; }, set: function(val) { promise = val; } },
    "ruler_object_top": { get: function() { return ruler_object_top; }, set: function(val) { ruler_object_top = val; } },
    "callback": { get: function() { return callback; }, set: function(val) { callback = val; } },
    "visible": { get: function() { return visible; }, set: function(val) { visible = val; } },
    "show_ruler": { get: function() { return show_ruler; }, set: function(val) { show_ruler = val; } },
    "_name_obj": { get: function() { return _name_obj; }, set: function(val) { _name_obj = val; } },
    "_plates_template": { get: function() { return _plates_template; }, set: function(val) { _plates_template = val; } },
    "z_position": { get: function() { return z_position; }, set: function(val) { z_position = val; } },
    "_plates_basic_template": { get: function() { return _plates_basic_template; }, set: function(val) { _plates_basic_template = val; } },
    "_place_key": { get: function() { return _place_key; }, set: function(val) { _place_key = val; } },
    "_G_step_vert": { get: function() { return _G_step_vert; }, set: function(val) { _G_step_vert = val; } },
    "_leg_mouting_offset": { get: function() { return _leg_mouting_offset; }, set: function(val) { _leg_mouting_offset = val; } },
    "_STATE_skeleton": { get: function() { return _STATE_skeleton; }, set: function(val) { _STATE_skeleton = val; } },
    "_top_lable_y_pos": { get: function() { return _top_lable_y_pos; }, set: function(val) { _top_lable_y_pos = val; } },
    "_cam_update_counter": { get: function() { return _cam_update_counter; }, set: function(val) { _cam_update_counter = val; } },
    "j": { get: function() { return j; }, set: function(val) { j = val; } },
    "_zoom_step": { get: function() { return _zoom_step; }, set: function(val) { _zoom_step = val; } },
    "ruler_object_left": { get: function() { return ruler_object_left; }, set: function(val) { ruler_object_left = val; } },
    "_name_basic": { get: function() { return _name_basic; }, set: function(val) { _name_basic = val; } },
    "_plates_x_position": { get: function() { return _plates_x_position; }, set: function(val) { _plates_x_position = val; } },
    "i": { get: function() { return i; }, set: function(val) { i = val; } },
    "_plates_basic_group": { get: function() { return _plates_basic_group; }, set: function(val) { _plates_basic_group = val; } },
    "_place_configuration": { get: function() { return _place_configuration; }, set: function(val) { _place_configuration = val; } },
    "_basic_modules_arr": { get: function() { return _basic_modules_arr; }, set: function(val) { _basic_modules_arr = val; } },
    "_top_lable_z_pos": { get: function() { return _top_lable_z_pos; }, set: function(val) { _top_lable_z_pos = val; } },
    "_anim_running": { get: function() { return _anim_running; }, set: function(val) { _anim_running = val; } },
    "_JSON_placement_rules": { get: function() { return _JSON_placement_rules; }, set: function(val) { _JSON_placement_rules = val; } },
    "ruler_object_bottom": { get: function() { return ruler_object_bottom; }, set: function(val) { ruler_object_bottom = val; } },
    "_name_obj_basic": { get: function() { return _name_obj_basic; }, set: function(val) { _name_obj_basic = val; } },
    "_plates_z_position": { get: function() { return _plates_z_position; }, set: function(val) { _plates_z_position = val; } },
    "_place_direction": { get: function() { return _place_direction; }, set: function(val) { _place_direction = val; } },
    "placeholder_modules_arr": { get: function() { return placeholder_modules_arr; }, set: function(val) { placeholder_modules_arr = val; } },
    "_STATE_addon_module": { get: function() { return _STATE_addon_module; }, set: function(val) { _STATE_addon_module = val; } },
    "_STATE_top_lable": { get: function() { return _STATE_top_lable; }, set: function(val) { _STATE_top_lable = val; } },
    "_top_lable_xyz_scale": { get: function() { return _top_lable_xyz_scale; }, set: function(val) { _top_lable_xyz_scale = val; } },
    "_cam_shift": { get: function() { return _cam_shift; }, set: function(val) { _cam_shift = val; } },
    "_basic_module_id": { get: function() { return _basic_module_id; }, set: function(val) { _basic_module_id = val; } },
    "_temp_text": { get: function() { return _temp_text; }, set: function(val) { _temp_text = val; } },
    "_plates_temp": { get: function() { return _plates_temp; }, set: function(val) { _plates_temp = val; } },
    "_STATE_scene": { get: function() { return _STATE_scene; }, set: function(val) { _STATE_scene = val; } },
    "_STATE_basic_module": { get: function() { return _STATE_basic_module; }, set: function(val) { _STATE_basic_module = val; } },
    "calculated_width": { get: function() { return calculated_width; }, set: function(val) { calculated_width = val; } },
    "ruler_points": { get: function() { return ruler_points; }, set: function(val) { ruler_points = val; } },
    "_plates_arr": { get: function() { return _plates_arr; }, set: function(val) { _plates_arr = val; } },
    "_STATE_addon_plates": { get: function() { return _STATE_addon_plates; }, set: function(val) { _STATE_addon_plates = val; } },
    "_place_shift": { get: function() { return _place_shift; }, set: function(val) { _place_shift = val; } },
    "_plaсe_shift_z": { get: function() { return _pla_D1_81e_shift_z; }, set: function(val) { _pla_D1_81e_shift_z = val; } },
    "_character_number": { get: function() { return _character_number; }, set: function(val) { _character_number = val; } },
    "_JSON_font_path": { get: function() { return _JSON_font_path; }, set: function(val) { _JSON_font_path = val; } },
    "calculated_height": { get: function() { return calculated_height; }, set: function(val) { calculated_height = val; } },
    "LEG_WIDTH": { get: function() { return LEG_WIDTH; }, set: function(val) { LEG_WIDTH = val; } },
    "_plates_height_limit": { get: function() { return _plates_height_limit; }, set: function(val) { _plates_height_limit = val; } },
    "_STATE_basic_plates": { get: function() { return _STATE_basic_plates; }, set: function(val) { _STATE_basic_plates = val; } },
    "_top_label_single_char": { get: function() { return _top_label_single_char; }, set: function(val) { _top_label_single_char = val; } },
    "_cam_module_target_position_x": { get: function() { return _cam_module_target_position_x; }, set: function(val) { _cam_module_target_position_x = val; } },
    "calculated_depth": { get: function() { return calculated_depth; }, set: function(val) { calculated_depth = val; } },
    "DISTANCE_TO_FLOOR": { get: function() { return DISTANCE_TO_FLOOR; }, set: function(val) { DISTANCE_TO_FLOOR = val; } },
    "_plates_z_step": { get: function() { return _plates_z_step; }, set: function(val) { _plates_z_step = val; } },
    "_3_15_exeption": { get: function() { return _3_15_exeption; }, set: function(val) { _3_15_exeption = val; } },
    "_cam_module_target_position_z": { get: function() { return _cam_module_target_position_z; }, set: function(val) { _cam_module_target_position_z = val; } },
    "ONE_BOX_WIDTH": { get: function() { return ONE_BOX_WIDTH; }, set: function(val) { ONE_BOX_WIDTH = val; } },
    "_plates_x_step": { get: function() { return _plates_x_step; }, set: function(val) { _plates_x_step = val; } },
    "ONE_BOX_HEIGHT": { get: function() { return ONE_BOX_HEIGHT; }, set: function(val) { ONE_BOX_HEIGHT = val; } },
    "_plates_shift": { get: function() { return _plates_shift; }, set: function(val) { _plates_shift = val; } },
    "_cam_position_x": { get: function() { return _cam_position_x; }, set: function(val) { _cam_position_x = val; } },
    "TOP_LABLE_HEIGHT": { get: function() { return TOP_LABLE_HEIGHT; }, set: function(val) { TOP_LABLE_HEIGHT = val; } },
    "_plates_max": { get: function() { return _plates_max; }, set: function(val) { _plates_max = val; } },
    "_top_label_text_area": { get: function() { return _top_label_text_area; }, set: function(val) { _top_label_text_area = val; } },
    "_cam_position_z": { get: function() { return _cam_position_z; }, set: function(val) { _cam_position_z = val; } },
    "_plates_group": { get: function() { return _plates_group; }, set: function(val) { _plates_group = val; } },
    "_cam_state": { get: function() { return _cam_state; }, set: function(val) { _cam_state = val; } },
    "_plates_row_limit": { get: function() { return _plates_row_limit; }, set: function(val) { _plates_row_limit = val; } },
    "_basic_temp_emptyes": { get: function() { return _basic_temp_emptyes; }, set: function(val) { _basic_temp_emptyes = val; } },
    "_counter": { get: function() { return _counter; }, set: function(val) { _counter = val; } },
    "_temp_module": { get: function() { return _temp_module; }, set: function(val) { _temp_module = val; } },
});

var _name, _plates_amount, x_position, _plates_basic_arr, _place_type, _G_step_hor, mailbox_obj, _top_lable_x_pos, _cam_update_requests, columns, row, col, parent2, template, where, num, promise, ruler_object_top, callback, visible, show_ruler, _name_obj, _plates_template, z_position, _plates_basic_template, _place_key, _G_step_vert, _leg_mouting_offset, _STATE_skeleton, _top_lable_y_pos, _cam_update_counter, j, _zoom_step, ruler_object_left, ruler_points, _name_basic, _plates_x_position, i, _plates_basic_group, _place_configuration, _basic_modules_arr, _top_lable_z_pos, _anim_running, _JSON_placement_rules, ruler_object_bottom, LEG_WIDTH, _STATE_addon_plates, _name_obj_basic, _plates_z_position, _place_direction, placeholder_modules_arr, _STATE_addon_module, _STATE_top_lable, _top_lable_xyz_scale, _cam_shift, _basic_module_id, _temp_text, _plates_temp, _STATE_scene, _STATE_basic_module, calculated_width, DISTANCE_TO_FLOOR, _STATE_basic_plates, _plates_arr, _place_shift, _pla_D1_81e_shift_z, _character_number, _JSON_font_path, calculated_height, ONE_BOX_WIDTH, _plates_height_limit, _top_label_single_char, _cam_module_target_position_x, calculated_depth, ONE_BOX_HEIGHT, _plates_z_step, _3_15_exeption, _cam_module_target_position_z, TOP_LABLE_HEIGHT, _plates_x_step, _plates_shift, _cam_position_x, _plates_max, _top_label_text_area, _cam_position_z, _plates_group, _cam_state, _plates_row_limit, _basic_temp_emptyes, _counter, _temp_module;
  ...
  if (dictGet(_STATE_addon_plates, 'type') == 'engrave') {
    ...
    "_temp_module": { get: function() { return _temp_module; }, set: function(val) { _temp_module = val; } },
      ...
      if (_name) {
        ...
        updateTextObj(_name_obj, dictGet(_STATE_addon_plates, 'default_name'));
      }
    }
  }
  if (dictGet(_STATE_basic_plates, 'type') == 'engrave') {
    ...
    "_temp_module": { get: function() { return _temp_module; }, set: function(val) { _temp_module = val; } },
      ...
      if (_name_basic) {
        ...
        updateTextObj(_name_obj_basic, dictGet(_STATE_basic_plates, 'default_name'));
      }
    }
  }
}
...
function configure_basic_plates() {
  ...
  if (dictGet(_STATE_basic_plates, 'visible')) {
    ...
    "_temp_module": { get: function() { return _temp_module; }, set: function(val) { _temp_module = val; } },
      ...
      _plates_basic_group = ['plate_group_',_basic_modules_arr.indexOf(i) + 1,'_basic'].join('');
      createObject('EMPTY', _plates_basic_group, 0, 0, 0, 0, 0, 0, 'PERSPECTIVE', 'AMBIENT', 0);
      clone_group(_plates_basic_group, _plates_basic_template, '_basic', _basic_modules_arr.indexOf(i) + 1);
      setObjTransform(_plates_basic_group, false, 'position', [getObjTransform(i, false, 'position', 'x'), getObjTransform(i, false, 'position', 'y'), getObjTransform(i, false, 'position', 'z')], false);
  ...
  if (dictGet(_STATE_addon_plates, 'visible')) {
    if (_3_15_exeption != true) {
      ...
      if (dictGet(_STATE_addon_plates, 'type') == 'plate') {
        ...
        for (let i = 0; i_inc >= 0 ? i <= _plates_amount : i >= _plates_amount; i += i_inc) {
        var VARS = Object.defineProperties({}, {
    "_name": { get: function() { return _name; }, set: function(val) { _name = val; } },
    "_plates_amount": { get: function() { return _plates_amount; }, set: function(val) { _plates_amount = val; } },
    "x_position": { get: function() { return x_position; }, set: function(val) { x_position = val; } },
    ...
    "_temp_module": { get: function() { return _temp_module; }, set: function(val) { _temp_module = val; } },
          ...
          setMorphFactor('ring_buttons_module', 'engraving_' + String(i), 1);
        }
      }
      if (dictGet(_STATE_skeleton, 'mirrored')) {
        _plates_shift = _G_step_hor * (dictGet(_place_configuration, 'row_1').length - 1);
      } else {
        _plates_shift = 0;
      }
    ...
    "_temp_module": { get: function() { return _temp_module; }, set: function(val) { _temp_module = val; } },
        ...
        if (i <= _plates_row_limit) {
          ...
          x_position = (i * _plates_x_step - _plates_x_step * 4) + _plates_shift;
          z_position = _plates_z_step * 2 - _pla_D1_81e_shift_z;
        } else if (i > _plates_row_limit * 2 && i <= _plates_row_limit * 3) {
          x_position = (i * _plates_x_step - _plates_x_step * 7) + _plates_shift;
          z_position = _plates_z_step * 3 - _pla_D1_81e_shift_z;
        } else if (i > _plates_row_limit * 3 && i <= _plates_row_limit * 4) {
          x_position = (i * _plates_x_step - _plates_x_step * 10) + _plates_shift;
          z_position = _plates_z_step * 4 - _pla_D1_81e_shift_z;
        } else if (i > _plates_row_limit * 4 && i <= _plates_row_limit * 5) {
          x_position = (i * _plates_x_step - _plates_x_step * 13) + _plates_shift;
          z_position = _plates_z_step * 5 - _pla_D1_81e_shift_z;
        }
        _plates_group = ['plate_group_',i,'_addon'].join('');
        createObject('EMPTY', _plates_group, 0, 0, 0, 0, 0, 0, 'PERSPECTIVE', 'AMBIENT', 0);
        clone_group(_plates_group, _plates_template, '_addon', i);
        setObjTransform(_plates_group, false, 'position', [_plates_x_position + x_position, '', _plates_z_position + z_position], false);
        ...
        if (dictGet(_STATE_addon_plates, 'light_ring')) {
          if (dictGet(_STATE_skeleton, 'addon_module') == false) {
            if (i != _plates_max) {
              if (i % 3 == 0) {
                setObjTransform('light_ring', false, 'position', [(_plates_x_position + x_position) - _plates_x_step * 2, '', _plates_z_position + z_position + _plates_z_step], false);
              } else {
                setObjTransform('light_ring', false, 'position', [_plates_x_position + x_position + _plates_x_step, '', _plates_z_position + z_position], false);
              }
...
function chenge_handle_color() {
  if (dictGet(_STATE_skeleton, 'handle_color')) {
    assignMat(['addon_module_panel', 'basic_module', 'ring_buttons_module'], 'antracite_handle_mat');
  } else {
    assignMat(['addon_module_panel', 'basic_module', 'ring_buttons_module'], 'brushed_steel_handle_mat');

    operateAnimation('SET_FRAME', '_material_store_steel', 50, null, 'AUTO', 1,
            function() {}, false);
...
function cofigure_skeleton() {
  if (dictGet(_STATE_addon_plates, 'visible') || dictGet(_STATE_skeleton, 'addon_module')) {
  ...
  _place_key = [dictGet(_STATE_skeleton, 'rows'),'-',dictGet(_STATE_skeleton, 'amount')].join('');
  if (_place_key == '3-15') {
    changeVis(['GROUP', 'addon_module'], false);
    _3_15_exeption = true;
  } else {
  ...
  _place_configuration = dictGet(dictGet(_JSON_placement_rules, _place_type), _place_key);
  /* Set direction */
  if (dictGet(_STATE_skeleton, 'mirrored')) {
    _place_direction = -1;
    _place_shift = _G_step_hor * (dictGet(_place_configuration, 'row_1').length - 1);
  } else {
    _place_direction = 1;
    _place_shift = 0;
  }
  setObjTransform('addon_module_group', false, 'position', [_place_shift, '', ''], false);
  /* Clean modules */
  ...
  var VARS = Object.defineProperties({}, {
    ...
    "_temp_module": { get: function() { return _temp_module; }, set: function(val) { _temp_module = val; } },
      ...
      if (j == 'B') {
        ...
        setObjTransform(_temp_module, false, 'position', [_place_shift + _counter * _G_step_hor * _place_direction, '', (i - 1) * _G_step_vert], false);
  ...
  if (dictGet(_STATE_skeleton, 'mounting')) {
    setMorphFactor('frame_wall_mounting', 'width', dictGet(_place_configuration, 'row_1').length - 1);
    setMorphFactor('frame_wall_mounting', 'height', dictGet(_STATE_skeleton, 'rows') - 1);
  } else {
    setMorphFactor('leg_mounting', 'width', dictGet(_place_configuration, 'row_1').length - 1);
    setMorphFactor('leg_mounting', 'height', dictGet(_STATE_skeleton, 'rows') - 1);
  }
  configure_addon_plates();
  configure_basic_plates();
  up_camera(dictGet(_STATE_skeleton, 'rows'), dictGet(_place_configuration, 'row_1').length);
...
function configure_mounting() {
  ...
  if (dictGet(_STATE_skeleton, 'mounting')) {
    ...
    "_temp_module": { get: function() { return _temp_module; }, set: function(val) { _temp_module = val; } },
      ...
      setObjTransform(i, false, 'position', ['', _leg_mouting_offset, ''], false);
    }
...
function light_on() {
  ...
  if (dictGet(_STATE_addon_plates, 'light_ring_on')) {
    ...
    setMaterialColor('button_light_mat', 'RGB_buttons_light ', 0, 0, 0, dictGet(_STATE_addon_plates, 'light_ring_color'));
  } else {
...
function configure_top_lable_name() {
  if (dictGet(_STATE_top_lable, 'name')) {
    updateTextObj([['GROUP', 'top_lable'], ['GROUP', 'top_lable_mirrored'], ['GROUP', 'top_lable_center']], dictGet(_STATE_top_lable, 'name'));
  } else {
    updateTextObj([['GROUP', 'top_lable'], ['GROUP', 'top_lable_mirrored'], ['GROUP', 'top_lable_center']], dictGet(_STATE_top_lable, 'default_name'));
  }
}
...
function configure_top_lable(columns) {
  ...
  _top_lable_xyz_scale = Math.min(Math.max((_top_label_text_area / _character_number) / _top_label_single_char, 1), 3.8);
  if (dictGet(_STATE_top_lable, 'top_lable')) {
    ...
    if (dictGet(_STATE_top_lable, 'top_text') == 'right') {
      ...
      changeVis(['GROUP', 'top_lable'], false);
      changeVis(['GROUP', 'top_lable_center'], false);
      setObjTransform('name_text_group_mirrored', false, 'position', [(columns - 1) * 0.385 + _top_lable_x_pos + 0.36, _top_lable_y_pos, _top_lable_z_pos], false);
      if (columns >= 1) {
        setObjTransform('name_text_group_mirrored', false, 'scale', [_top_lable_xyz_scale, _top_lable_xyz_scale, _top_lable_xyz_scale], false);
      }
    } else if (dictGet(_STATE_top_lable, 'top_text') == 'left') {
      changeVis(['GROUP', 'top_lable'], true);
      setObjTransform('name_text_group', false, 'position', [_top_lable_x_pos, _top_lable_y_pos, _top_lable_z_pos], false);
      if (columns >= 1) {
        setObjTransform('name_text_group', false, 'scale', [_top_lable_xyz_scale, _top_lable_xyz_scale, _top_lable_xyz_scale], false);
      }
      changeVis(['GROUP', 'top_lable_mirrored'], false);
      changeVis(['GROUP', 'top_lable_center'], false);
    } else if (dictGet(_STATE_top_lable, 'top_text') == 'center') {
      changeVis(['GROUP', 'top_lable_center'], true);
      setObjTransform('name_text_group_center', false, 'position', [(columns - 1) * 0.192 + _top_lable_x_pos + 0.18, _top_lable_y_pos, _top_lable_z_pos], false);
      if (columns >= 1) {
        setObjTransform('name_text_group_center', false, 'scale', [_top_lable_xyz_scale, _top_lable_xyz_scale, _top_lable_xyz_scale], false);
      }
      changeVis(['GROUP', 'top_lable_mirrored'], false);
      changeVis(['GROUP', 'top_lable'], false);
    }
...
function cam_position() {
  ...
  if (dictGet(_STATE_skeleton, 'cam_addon_target')) {
    _cam_module_target_position_x = getObjTransform('addon_module', false, 'position', 'x');
    _cam_module_target_position_z = getObjTransform('addon_module', false, 'position', 'z') - 0.184698;
    setCameraParam('ALLOW_PANNING', 'Camera', true);
    setObjTransform('cam_module_target', false, 'position', [_cam_module_target_position_x, '', _cam_module_target_position_z], false);
    tweenCamera('cam_module_position', 'cam_module_target', 2, function() {}, 0);
    dictSet(_STATE_scene, 'defalult_cam position', false);
  } else if (_basic_module_id >= 2 && _basic_module_id <= 16) {
    _cam_module_target_position_x = getObjTransform('basic_module' + String(_basic_module_id), false, 'position', 'x') - _cam_shift;
    _cam_module_target_position_z = getObjTransform('basic_module' + String(_basic_module_id), false, 'position', 'z') - 0.184698;
    setObjTransform('cam_module_target', false, 'position', [_cam_module_target_position_x, '', _cam_module_target_position_z], false);
    tweenCamera('cam_module_position', 'cam_module_target', 2, function() {}, 0);
    setCameraParam('ALLOW_PANNING', 'Camera', true);
    dictSet(_STATE_scene, 'defalult_cam position', false);
  } else if (dictGet(_STATE_scene, 'defalult_cam position')) {
    tweenCamera('camera_default_position', 'camera_default_target', 2, function() {}, 0);
  } else {
    setCameraParam('ALLOW_PANNING', 'Camera', true);
    registerEveryFrame(function() {
      if (_cam_update_requests.slice(-1)[0]) {
        if (_cam_update_requests.slice(-1)[0] != _cam_update_counter) {
          if (!_anim_running) {
            ...
            setObjTransform('camera_default_target', false, 'position', [((_cam_state[0] - 1) * 0.341) / 2, '', -0.192 - ((_cam_state[1] - 1) * 0.385) / 2], false);
            if (dictGet(_STATE_skeleton, 'cam_addon_target') == false) {
              tweenCamera('camera_default_position', 'camera_default_target', 1.5, function() {}, 0);
            }
      ...
      if (_cam_position_x >= 5 || _cam_position_x <= -5) {
        tweenCamera('camera_default_position', 'camera_default_target', 4, function() {}, 0);
      }
...
var VARS = Object.defineProperties({}, {
  ...
  var VARS = Object.defineProperties({}, {
    ...
    if (j == 'engrave_basic_text') {
      ...
      createTextObject(_temp_text, dictGet(_STATE_basic_plates, 'default_name'), dictGet(_JSON_font_path, dictGet(_STATE_basic_plates, 'font')), 0.012, 0.0001, 'center', 'topBaseline', 2, 0, 0, function() {});
      setObjTransform(_temp_text, false, 'position', getObjTransform('engrave_basic_text', true, 'position', 'xyz'), false);
      ...
      createTextObject(_temp_text, dictGet(_STATE_addon_plates, 'default_name'), dictGet(_JSON_font_path, dictGet(_STATE_addon_plates, 'font')), 0.012, 0.0001, 'center', 'topBaseline', 2, 0, 0, function() {});
      setObjTransform(_temp_text, false, 'position', getObjTransform('engrave_text', true, 'position', 'xyz'), false);
      ...
      'VARS._plates_temp = obj.name;')))(appInstance, v3d, PL, VARS, PROC);
...
// Describe this function...
function init() {
  loadFile('./json/placement_rules.json', function() {
    _JSON_placement_rules = _pGlob.loadedFile;
    loadFile('./json/fonts.json', function() {
      _JSON_font_path = _pGlob.loadedFile;
      changeVis([['GROUP', 'basic_module'], ['GROUP', 'addon_module'], ['GROUP', 'placeholder_module'], ['GROUP', 'plate'], ['GROUP', 'engrave'], 'leg_mounting', ['GROUP', 'top_lable'], 'light_ring', ['GROUP', 'top_lable_mirrored'], ['GROUP', 'materials_store']], false);
      cofigure_skeleton();
      configure_mounting();
...
function set_transparent() {
  ...
  operateAnimation('STOP', 'addon_module_panel', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'basic_module', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'ring_buttons_module', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'leg_mounting', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'frame_wall_mounting', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'placeholder_module', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', '_material_store_steel', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'plate_basic_plate', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'addon_module', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'plate_plate', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'plate_ring', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'light_ring', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'engrave_ring', null, null, 'AUTO', 1,
          function() {}, false);

      if (dictGet(_STATE_skeleton, 'transparent')) {

    operateAnimation('PLAY', 'addon_module_panel', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'basic_module', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'ring_buttons_module', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'leg_mounting', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'frame_wall_mounting', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'placeholder_module', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', '_material_store_steel', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'plate_basic_plate', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'addon_module', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'plate_plate', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'plate_ring', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'light_ring', null, null, 'LoopOnce', 1,
            function() {}, false);


    operateAnimation('PLAY', 'engrave_ring', null, null, 'LoopOnce', 1,
            function() {}, false);
...
var VARS = Object.defineProperties({}, {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('VARS.promise = new Promise(function(resolve, reject) {' + '\n' +
...
var VARS = Object.defineProperties({}, {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('app.camera.clearViewOffset();' + '\n' +
...
function add_ruler() {
  ...
  calc_dimensions();
  setObjTransform('myObject', false, 'position', getObjTransform('camera_preview_position', false, 'position', 'xyz'), false);
  setObjTransform('myObject2', false, 'position', getObjTransform('camera_default_target', false, 'position', 'xyz'), false);
  ...
  setHTMLElemAttribute('className', 'ruler_text', 'bottom_ruler_text', false);
  addHTMLElement('div', 'top_ruler_text_content', 'TO', ['QUERYSELECTOR', '#top_ruler_text'], false);
  addHTMLElement('div', 'left_ruler_text_content', 'TO', ['QUERYSELECTOR', '#left_ruler_text'], false);
  addHTMLElement('div', 'bottom_ruler_text_content', 'TO', ['QUERYSELECTOR', '#bottom_ruler_text'], false);
  setHTMLElemAttribute('innerHTML', String(['<div>',calculated_width,'</div>'].join('')) + '<div>mm</div>', 'top_ruler_text_content', false);
  setHTMLElemAttribute('innerHTML', String(['<div>',calculated_height,'</div>'].join('')) + '<div>mm</div>', 'left_ruler_text_content', false);
  setHTMLElemAttribute('innerHTML', String(['<div>',calculated_depth,'</div>'].join('')) + '<div>mm</div>', 'bottom_ruler_text_content', false);
  setHTMLElemAttribute('className', 'ruler_text_content', 'top_ruler_text_content', false);
  setHTMLElemAttribute('className', 'ruler_text_content', 'left_ruler_text_content', false);
  setHTMLElemAttribute('className', 'ruler_text_content', 'bottom_ruler_text_content', false);
...
function remove_ruler() {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('if (VARS.ruler_object_top) app.scene.remove(VARS.ruler_object_top);' + '\n' +
...
function calc_dimensions() {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('let height = 0;' + '\n' +
...
function pass_names_to_arr() {
  dictSet(_STATE_addon_plates, 'names', ['Hello, Verge!', 'Privet', 'Aloha']);
  dictSet(_STATE_basic_plates, 'names', ['Hello, Verge!', 'Privet', 'Aloha', 'Aloha', 'Aloha', 'Aloha', 'Aloha', 'Aloha']);
...
eventHTMLElem('click', 'mirrored', true, function(event) {
  dictSet(_STATE_skeleton, 'mirrored', toNumber(getHTMLElemAttribute('checked', 'mirrored', true)));
  cofigure_skeleton();
});
eventHTMLElem('click', 'addon_module', true, function(event) {
  dictSet(_STATE_skeleton, 'addon_module', toNumber(getHTMLElemAttribute('checked', 'addon_module', true)));
  cofigure_skeleton();
});
eventHTMLElem('click', 'custom_plates_amount', true, function(event) {
  dictSet(_STATE_addon_plates, 'custom', toNumber(getHTMLElemAttribute('checked', 'custom_plates_amount', true)));
  configure_addon_plates();
});
eventHTMLElem('click', 'addon_plates', true, function(event) {
  dictSet(_STATE_addon_plates, 'visible', toNumber(getHTMLElemAttribute('checked', 'addon_plates', true)));
  cofigure_skeleton();
});
eventHTMLElem('input', 'plates_amount', true, function(event) {
  dictSet(_STATE_addon_plates, 'amount', toNumber(getHTMLElemAttribute('value', 'plates_amount', true)));
  configure_addon_plates();
});
...
eventHTMLElem('click', 'basic_plates', true, function(event) {
  dictSet(_STATE_basic_plates, 'visible', toNumber(getHTMLElemAttribute('checked', 'basic_plates', true)));
  configure_basic_plates();
});
...
Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window._VARS = VARS;' + '\n' +
'')))(appInstance, v3d, PL, VARS, PROC);
...
mailbox_obj = ['addon_module_group', ['GROUP', 'mounting'], ['GROUP', 'basic_module'], 'engrave_group', ['GROUP', 'placeholder_module'], 'plate_group', 'light_ring'];
...
eventHTMLElem('input', 'rows', true, function(event) {
  dictSet(_STATE_skeleton, 'rows', toNumber(getHTMLElemAttribute('value', 'rows', true)));
  dictSet(_STATE_skeleton, 'rows_avto', false);
  cofigure_skeleton();
});
eventHTMLElem('input', 'amount', true, function(event) {
  dictSet(_STATE_skeleton, 'amount', toNumber(getHTMLElemAttribute('value', 'amount', true)));
  cofigure_skeleton();
});

eventHTMLElem('input', 'top_label', true, function(event) {
  if (getHTMLElemAttribute('value', 'top_label', true) != '') {
    dictSet(_STATE_top_lable, 'name', getHTMLElemAttribute('value', 'top_label', true));
    cofigure_skeleton();
  }
});
eventHTMLElem('input', 'button_color', true, function(event) {
  if (getHTMLElemAttribute('value', 'button_color', true) != '') {
    dictSet(_STATE_addon_plates, 'light_ring_color', getHTMLElemAttribute('value', 'button_color', true));
    light_on();
  }
});
...
eventHTMLElem('input', 'basic_module_id', true, function(event) {
  if (getHTMLElemAttribute('value', 'basic_module_id', true) != '') {
    dictSet(_STATE_basic_module, 'id', getHTMLElemAttribute('value', 'basic_module_id', true));
  }
  cam_position();
});
...
Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'window.app = app;')(appInstance, v3d, PL, VARS, PROC);
...
calculated_height = 0;
calculated_depth = 0;
createObject('EMPTY', 'top_ruler', 0, 0, 0, 0, 0, 0, 'PERSPECTIVE', 'AMBIENT', 0);
createObject('EMPTY', 'left_ruler', 0, 0, 0, 0, 0, 0, 'PERSPECTIVE', 'AMBIENT', 0);
createObject('EMPTY', 'bottom_ruler', 0, 0, 0, 0, 0, 0, 'PERSPECTIVE', 'AMBIENT', 0);
createCSSRule('.ruler_text', 'position: absolute', false, '');
createCSSRule('.ruler_text', 'padding:4px', false, '');
createCSSRule('.ruler_text', 'display: flex; align-items: center; justify-content: center;', false, '');
createCSSRule('#top_ruler_text_content', 'position: absolute; top: -200%; color: #333333; user-select: none;', false, '');
createCSSRule('#left_ruler_text_content', 'position: absolute; right: 10px; top: -100%; color: #333333; user-select: none;', false, '');
createCSSRule('#bottom_ruler_text_content', 'position: absolute; top: -200%; right: 10px; color: #333333; user-select: none;', false, '');
createCSSRule('.ruler_text_content', 'display: flex;     gap: 4px;    background: white;     padding: 2px;     border-radius: 4px;', false, '');

createObject('EMPTY', 'camera_preview_position', 0, 0, 0, 0, 0, 0, 'PERSPECTIVE', 'AMBIENT', 0);
...
eventHTMLElem('click', 'zoom_in', true, function(event) {
  if (getHTMLElemAttribute('value', 'zoom_step', true) != '') {
    dictSet(_STATE_scene, 'zoom_step', toNumber(getHTMLElemAttribute('value', 'zoom_step', true)));
  }
  zoom_in();
});
